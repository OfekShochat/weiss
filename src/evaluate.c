...
const int KingLineDanger[28] = {
    S(  0,  0), S(  0,  0), S( -6,  0), S(-17,  0),
    S(-31,  0), S(-37,  0), S(-36,  0), S(-38,  0),
    S(-41,  0), S(-53,  0), S(-49,  0), S(-59,  0),
    S(-60,  0), S(-62,  0), S(-62,  0), S(-55,  0),
    S(-51,  0), S(-38,  0), S(-31,  0), S(-29,  0),
    S(-26,  0), S(-32,  0), S(-37,  0), S(-59,  0),
    S(-84,  0), S(-103, 0), S(-107, 0), S(-112, 0),
};
